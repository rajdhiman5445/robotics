...
\[ `\boxed{\mathbf{t}_E^0 = J(q)\dot{\mathbf q}}`{=tex} \]

where:

-   (J(q)) = Jacobian,
-   (`\dot{\mathbf q}`{=tex}) = vector of joint velocities,
-   (`\mathbf `{=tex}t_E\^0) = end-effector twist expressed in the base
    frame.
...
\[
`\boxed{\text{joint velocity} \longrightarrow \text{end-effector velocity}}`{=tex}
\]
...
\[ q_i=`\theta`{=tex}\_i, `\qquad`{=tex}
`\dot `{=tex}q_i=`\dot`{=tex}`\theta`{=tex}\_i. \]

For a prismatic joint,

\[ q_i=d_i, `\qquad`{=tex} `\dot `{=tex}q_i=`\dot `{=tex}d_i. \]
...
is a (3`\times3`{=tex}) rotation matrix and
...
\[ T_0^1,`\quad `{=tex}T_1^2,`\quad `{=tex}T_2\^3,`\ldots`{=tex} \]
...
> Give Python (`\alpha`{=tex},a,d,`\theta`{=tex}), and Python constructs
> this matrix.
...
For the (4`\times4`{=tex}) homogeneous matrix:
...
Each (J_i) is a (6`\times1`{=tex}) column.
...
\[ `\mathbf `{=tex}t_E\^0 = J_1`\dot `{=tex}q_1+J_2`\dot `{=tex}q_2. \]
...
For a prismatic joint, the lab's (`\epsilon`{=tex}\_i) formulation gives
...
\[ `\sin`{=tex}(q_1),`\qquad`{=tex} `\cos`{=tex}(q_1),`\qquad`{=tex}
`\sin`{=tex}(q_1+q_2). \]
...
We don't want to manually write the (4`\times4`{=tex}) matrix ten times.
...
\[ T_0\^1,`\quad`{=tex} T_0\^2,`\quad`{=tex}
T_0\^3,`\quad`{=tex}`\ldots`{=tex},`\quad`{=tex} T_0\^n. \]
...
creates the (4`\times4`{=tex}) identity matrix.
...
Its DH table is:
  ...
  Link     (`\alpha`{=tex}\_{i-1})   (a\_{i-1})   (d_i)   (`\theta`{=tex}\_i)
  ------ ------------------------- ------------ ------- ---------------------
  1                              0            0       0   (`\theta`{=tex}\_1)
  2           (-90\^`\circ`{=tex})        (a_1)   (d_2)                     0
...
The supplied DH table contains:
  ...
  -----------------------------------------------------------------------------------------
  Link          (`\alpha`{=tex}\_{i-1})     (a\_{i-1})     (d_i) (mm)   (`\theta`{=tex}\_i)
                                                  (mm)                
  ----------- ------------------------- -------------- -------------- ---------------------
  1                                   0             12             77   (`\theta`{=tex}\_1)

  2                    (-`\pi`{=tex}/2)              0              0   (`\theta`{=tex}\_2)

  3                                   0            130              0   (`\theta`{=tex}\_3)

  4                                   0            124              0   (`\theta`{=tex}\_4)
  -----------------------------------------------------------------------------------------
...
\[ `\mathbf `{=tex}t_E\^0 = J_1`\dot `{=tex}q_1+ J_2`\dot `{=tex}q_2+
J_3`\dot `{=tex}q_3+ J_4`\dot `{=tex}q_4. \]
...
if you mean (90\^`\circ`{=tex}).

That means (`\sin`{=tex}(90`\text{ radians}`{=tex})).
...
\[ `\alpha`{=tex}\_i,a_i,d_i,`\theta`{=tex}\_i. \]
...
10. Why does an (n)-joint robot have a (6`\times `{=tex}n) Jacobian?
...
\[ (`\alpha`{=tex}*{i-1},a*{i-1},d_i,`\theta`{=tex}\_i) \]
...
\[ T_0^i=T_0^1T_1^2`\cdots `{=tex}T\_{i-1}^{i} \]

## Extract

\[ z_i^0=`\text{third column of }`{=tex}R_0^i \]

\[ o_i^0=`\text{fourth column of }`{=tex}T_0^i \]

## End effector

\[ o_E^0=`\text{position from }`{=tex}T_0^n \]
...
\[ `\boxed{\mathbf t_E^0=J\dot q}`{=tex} \]
